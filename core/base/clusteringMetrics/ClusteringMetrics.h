...
/// \date The Date Here.
///
/// This module defines the %ClusteringMetrics class that computes for each
...
namespace ttk {
  ...
  /**
   * The ClusteringMetrics class provides methods to compute for each vertex of
  ...
  public:
    ...
    int compute_contingency_tables(
    ...
    int compute_ARI(std::vector<std::vector<int>> &contingencyMatrix,
                    const std::vector<int> &sumLin,
                    const std::vector<int> &sumCol,
                    int nPoint,
                    double &ariValue) const;
    int compute_NMI(std::vector<std::vector<int>> &contingencyMatrix,
                    const std::vector<int> &sumLin,
                    const std::vector<int> &sumCol,
                    int nPoint,
