...
template class ttk::PeriodicWithPreconditions<0>;
template class ttk::PeriodicWithPreconditions<1>;
template class ttk::PeriodicWithPreconditions<2>;
template class ttk::PeriodicWithPreconditions<3>;
template class ttk::PeriodicNoPreconditions<0>;
template class ttk::PeriodicNoPreconditions<1>;
template class ttk::PeriodicNoPreconditions<2>;
template class ttk::PeriodicNoPreconditions<3>;
