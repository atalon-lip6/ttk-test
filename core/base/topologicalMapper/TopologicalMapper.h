...
/// \date The Date Here.
///
/// This module defines the %TopologicalMapper class that computes for each vertex of a
...
namespace ttk {
  ...
  /**
   * The TopologicalMapper class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
