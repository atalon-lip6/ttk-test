...
int ttkClusteringMetrics::RequestData(vtkInformation *ttkNotUsed(request),
  ...
  const auto intArray1
    = vtkIntArray::SafeDownCast(inputClustering1); //    this->GetInputAbstractArrayToProcess(0,
                                                   //    inputVector));
  const auto intArray2
    = vtkIntArray::SafeDownCast(inputClustering2); //    this->GetInputAbstractArrayToProcess(0,
                                                   //    inputVector));
