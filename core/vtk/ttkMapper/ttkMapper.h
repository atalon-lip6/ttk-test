...
private:
  ...
  bool needWholeUpdate_{
    true}; // To avoid to recompute everything when not necessary.
  bool firstTimeReembed_{true}; // To avoid to recompute everything when not
                                // necessary. //Check sze f arrays...
