...
///
/// \ingroup vtk
/// \class ttkTemplatingTest
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::TemplatingTest module.
///
/// This VTK filter uses the ttk::TemplatingTest module to compute an averaging of
...
///   - standalone/TemplatingTest/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::TemplatingTest
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkTemplatingTestModule.h>
...
// TTK Base Includes
#include <TemplatingTest.h>

class TTKTEMPLATINGTEST_EXPORT ttkTemplatingTest
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::TemplatingTest // and we inherit from the base class
{
private:
  /**
...
public:
   ...
   */
  static ttkTemplatingTest *New();
  vtkTypeMacro(ttkTemplatingTest, ttkAlgorithm);
...
protected:
   ...
   */
  ttkTemplatingTest();
  ~ttkTemplatingTest() override = default;
